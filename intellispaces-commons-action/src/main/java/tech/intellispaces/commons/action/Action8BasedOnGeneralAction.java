...
class Action8BasedOnGeneralAction<R, D1, D2, D3, D4, D5, D6, D7, D8> extends AbstractAction8<R, D1, D2, D3, D4, D5, D6, D7, D8> {
  private final Action action;

  Action8BasedOnGeneralAction(Action action) {
    this.action = action;
  }
