...
class Action8ConvertedFromAction9<R, _D1, _D2, _D3, _D4, _D5, _D6, _D7, _D8, D1, D2, D3, D4, D5, D6, D7, D8, D9> extends AbstractAction8<R, _D1, _D2, _D3, _D4, _D5, _D6, _D7, _D8> {
  private final Action9<R, D1, D2, D3, D4, D5, D6, D7, D8, D9> action9;
  ...
  Action8ConvertedFromAction9(
      Action9<R, D1, D2, D3, D4, D5, D6, D7, D8, D9> action9,
  ...
  @Override
  public R execute(_D1 data1, _D2 data2, _D3 data3, _D4 data4, _D5 data5, _D6 data6, _D7 data7, _D8 data8) {
    Object[] inputs = { data1, data2, data3, data4, data5, data6, data7, data8 };
    ...
    return action9.execute(targetData1, targetData2, targetData3, targetData4, targetData5, targetData6, targetData7, targetData8, targetData9);
  }

  @Override
  public int executeReturnInt(_D1 data1, _D2 data2, _D3 data3, _D4 data4, _D5 data5, _D6 data6, _D7 data7, _D8 data8) {
    Object[] inputs = { data1, data2, data3, data4, data5, data6, data7, data8 };
    D1 targetData1 = dataExtractor1.execute(inputs, 0);
    D2 targetData2 = dataExtractor2.execute(inputs, 1);
    D3 targetData3 = dataExtractor3.execute(inputs, 2);
    ...
    D8 targetData8 = dataExtractor8.execute(inputs, 7);
    D9 targetData9 = dataExtractor9.execute(inputs, 8);
    return action9.executeReturnInt(targetData1, targetData2, targetData3, targetData4, targetData5, targetData6, targetData7, targetData8, targetData9);
  }

  @Override
  public double executeReturnDouble(_D1 data1, _D2 data2, _D3 data3, _D4 data4, _D5 data5, _D6 data6, _D7 data7, _D8 data8) {
    Object[] inputs = { data1, data2, data3, data4, data5, data6, data7, data8 };
    D1 targetData1 = dataExtractor1.execute(inputs, 0);
    D2 targetData2 = dataExtractor2.execute(inputs, 1);
    D3 targetData3 = dataExtractor3.execute(inputs, 2);
    ...
    D8 targetData8 = dataExtractor8.execute(inputs, 7);
    D9 targetData9 = dataExtractor9.execute(inputs, 8);
    return action9.executeReturnDouble(targetData1, targetData2, targetData3, targetData4, targetData5, targetData6, targetData7, targetData8, targetData9);
  }
}
