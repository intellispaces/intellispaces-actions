package intellispaces.actions.multiaction;

import intellispaces.actions.AbstractAction5;
import intellispaces.actions.Action5;

import java.util.ArrayList;
import java.util.List;

class MultiAction5<R, D1, D2, D3, D4, D5>
    ...
    implements Action5<R, D1, D2, D3, D4, D5>
{
  ...
  MultiAction5(Action5<R, D1, D2, D3, D4, D5> action1, Action5<R, D1, D2, D3, D4, D5> action2) {
  ...
  private List<Action5<R, D1, D2, D3, D4, D5>> getActions(Action5<R, D1, D2, D3, D4, D5> action) {
    if (action instanceof MultiAction5) {
      return ((MultiAction5<R, D1, D2, D3, D4, D5>) action).actions();
    } else {
