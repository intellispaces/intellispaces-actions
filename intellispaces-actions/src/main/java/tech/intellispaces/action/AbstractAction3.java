...
public abstract class AbstractAction3<R, D1, D2, D3> implements Action3<R, D1, D2, D3> {
  ...
  public <_R> Action0<_R> castToAction0() {
    throw IrregularActionFormExceptions.withMessage("Action of form 3 can not be represented as action form 0");
  }

  @Override
  public <_R, _D> Action1<_R, _D> castToAction1() {
    throw IrregularActionFormExceptions.withMessage("Action of form 3 can not be represented as action form 1");
  }

  @Override
  public <_R, _D1, _D2> Action2<_R, _D1, _D2> castToAction2() {
    throw IrregularActionFormExceptions.withMessage("Action of form 3 can not be represented as action form 2");
  }
  ...
  public <_R, _D1, _D2, _D3, _D4> Action4<_R, _D1, _D2, _D3, _D4> castToAction4() {
    throw IrregularActionFormExceptions.withMessage("Action of form 3 can not be represented as action form 4");
  }

  @Override
  public <_R, _D1, _D2, _D3, _D4, _D5> Action5<_R, _D1, _D2, _D3, _D4, _D5> castToAction5() {
    throw IrregularActionFormExceptions.withMessage("Action of form 3 can not be represented as action form 5");
  }

  @Override
  public <_R, _D1, _D2, _D3, _D4, _D5, _D6> Action6<_R, _D1, _D2, _D3, _D4, _D5, _D6> castToAction6() {
    throw IrregularActionFormExceptions.withMessage("Action of form 3 can not be represented as action form 6");
  }
