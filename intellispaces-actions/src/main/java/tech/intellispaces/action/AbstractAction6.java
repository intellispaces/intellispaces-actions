...
public abstract class AbstractAction6<R, D1, D2, D3, D4, D5, D6> implements Action6<R, D1, D2, D3, D4, D5, D6> {
  ...
  public R execute(Object[] allData) {
    ...
    return execute((D1) allData[0], (D2) allData[1], (D3) allData[2], (D4) allData[3], (D5) allData[4], (D6) allData[5]);
  }
  ...
  public int executeReturnInt(Object[] allData) {
    ...
    return executeReturnInt((D1) allData[0], (D2) allData[1], (D3) allData[2], (D4) allData[3], (D5) allData[4], (D6) allData[5]);
  }
  ...
  public double executeReturnDouble(Object[] allData) {
    ...
    return executeReturnDouble((D1) allData[0], (D2) allData[1], (D3) allData[2], (D4) allData[3], (D5) allData[4], (D6) allData[5]);
  }
