...
public abstract class AbstractAction4<R, D1, D2, D3, D4> implements Action4<R, D1, D2, D3, D4> {
  ...
  public R execute(Object... inputData) {
    ...
    return execute((D1) inputData[0], (D2) inputData[1], (D3) inputData[2], (D4) inputData[3]);
  }
  ...
  public int executeReturnInt(Object... inputData) {
    ...
    return executeReturnInt((D1) inputData[0], (D2) inputData[1], (D3) inputData[2], (D4) inputData[3]);
  }
  ...
  public double executeReturnDouble(Object... inputData) {
    ...
    return executeReturnDouble((D1) inputData[0], (D2) inputData[1], (D3) inputData[2], (D4) inputData[3]);
  }
