...
public abstract class AbstractWrapperAction3<R, D1, D2, D3>
    extends AbstractAction3<R, D1, D2, D3>
    implements WrapperAction3<R, D1, D2, D3>
{
  private final Action3<R, D1, D2, D3> wrappedAction;

  public AbstractWrapperAction3(Action3<R, D1, D2, D3> wrappedAction) {
