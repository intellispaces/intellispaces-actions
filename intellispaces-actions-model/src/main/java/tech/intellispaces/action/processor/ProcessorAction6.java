 ...
 *
 * This action form takes six input data to process, it can to change one or more input data and
...
public interface ProcessorAction6<D1, D2, D3, D4, D5, D6> extends Action6<Void, D1, D2, D3, D4, D5, D6> {
   ...
   */
  ProcessorAction6<D1, D2, D3, D4, D5, D6> then(Action6<Void, D1, D2, D3, D4, D5, D6> nextAction);
